...
Open Dev Sideboard and take screenshots of Overview, Storage, and Cookies. Overview includes the page title, network activity, window and viewport sizing controls, and metadata. HTTPS is needed for Open Graph image previews. A `file://` page does not support the extension's inspection features.
