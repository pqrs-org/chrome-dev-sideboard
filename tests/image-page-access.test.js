...
test('same-origin image bytes use document-pinned extension ports without credentials', async () => {
  let options
...
test('page image requests reject other origins, credentials, HTTP, and oversized images', async () => {
  let calls = 0
  const s = setup(async () => {
    calls++
